        ...
        <div class="col-12 mb-4 mb-lg-0">
            <div class="row mt-3 mt-md-0">
                ...
                <div class="col-6 col-md-3 box-item py-3 px-4 text-center" v-if="writeraccess == 1">
                    <div >
                        <a class="py-4" :href="'/dashboard/wuser'">
                            <i class="fas fa-users fa-3x mb-2 d-block"></i>
                            کاربران
                        </a>
                    </div>
                </div>
                <div class="col-6 col-md-3 box-item py-3 px-4 text-center" v-if="settingaccess == 1">
                    <div >
                        <a class="py-4" :href="'/dashboard/workshop'">
                            <i class="fas fa-store-alt fa-3x mb-2 d-block"></i>
                            کارگاه
                        </a>
                    </div>
                </div>
...
<script>
    export default {
        ...
        props: ['useraccess', 'storeaccess', 'writeraccess', 'settingaccess'],
