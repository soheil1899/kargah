...
Vue.component('wuser-component', require('./components/admin/wusers/WuserComponent.vue').default);
Vue.component('wuserinfo-component', require('./components/admin/wusers/WuserinfoComponent.vue').default);
Vue.component('workshop-component', require('./components/admin/wusers/WorkshopComponent.vue').default);
